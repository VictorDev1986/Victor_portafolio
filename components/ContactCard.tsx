...
const ContactCard: React.FC = () => {
  return (
    <div className="relative z-10 bg-white/80 backdrop-blur-sm mt-4 rounded-lg shadow-md hover:shadow-lg border border-slate-200 p-6 w-full max-w-md mx-auto transition-all duration-300">
      <div className="mb-4">
        <div className="flex items-center gap-4 mb-3 text-xl">
          <FaEnvelope className="text-emerald-600 text-2xl" />
          <div>
            <h3 className="font-semibold text-lg text-slate-800">Correo</h3>
        ...
        <div className="flex items-center gap-4 text-xl">
          ...
          <div>
            <h3 className="font-semibold text-lg text-slate-800">Llámame</h3>
            <p className="text-lg text-slate-600">
